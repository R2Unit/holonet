...
func main() {
	...
	err = triggerWorkflowViaAPI(housekeepingWorkflow.ID, parametersJSON)
	if err != nil {
...
// triggerWorkflowViaAPI triggers a workflow execution via the API
func triggerWorkflowViaAPI(workflowID int, parameters json.RawMessage) error {
